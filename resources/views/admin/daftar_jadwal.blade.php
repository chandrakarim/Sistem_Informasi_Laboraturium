        ...
        <section class="content">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a href="{{ route('daftar.jadwal') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.jadwal')== 0) ? 'active' : '' }}">Daftar Jadwal</a>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('edit.view.jadwal', $j->id_jadwal) }}" class="btn btn-primary" type="button">Edit</a>
                                        <a href="{{ route('delete.jadwal', $j->id_jadwal) }}" class="btn btn-danger" type="button">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
