            ...
            <div class="row">
                <div class="col-md-3">
                  ...
                  <a href="{{ route('daftar.jadwal') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.jadwal')) ? 'active' : '' }}">Daftar Jadwal</a>
                        ...
                        <a href="{{ route('create.view.kelas') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'create.view.kelas') == 0) ? 'active' : '' }}">Buat Kelas Baru</a>                  
                ...
                <div class="col-md-9">
                  <div class="list-group">
                      ...
                      <form method="POST" action="{{ route('create.postKelas') }}" enctype="multipart/form-data">
                        @csrf
