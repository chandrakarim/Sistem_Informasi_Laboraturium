            ...
            <div class="row">
                ...
                <div class="col-md-9">
                  <div class="list-group">
                      ...
                      <form method="POST" action="{{ route('edit.putKelas', $kelas->id_kelas) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                          <div class="col-md-12 mt-3">
                            ...
                            <input type="text" class="form-control" name="kode_kelas" id="kode_kelas" value="{{ $kelas->kode_kelas }}">
                          </div>
                        </div>
