            ...
            <div class="row">
                <div class="col-md-3">
                  ...
                  <a href="{{ route('daftar.kelas') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.kelas')) ? 'active' : '' }}">Daftar Kelas</a>
                        ...
                        <a href="{{ route('create.view.matakuliah') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'create.view.matakuliah')== 0) ? 'active' : '' }}">Buat Matakuliah Baru</a>
                ...
                <div class="col-md-9">
                  <div class="list-group">
                      <button type="button" class="list-group-item list-group-item-action active">Tambah Matakuliah</button>
                      <form method="POST" action="{{ route('create.postMatakuliah') }}" enctype="multipart/form-data">
                        @csrf
