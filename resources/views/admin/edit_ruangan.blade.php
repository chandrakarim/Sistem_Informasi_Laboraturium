            ...
            <div class="row">
                <div class="col-md-3">
                  ...
                  <a href="{{ route('daftar.kelas') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.kelas')) ? 'active' : '' }}">Daftar Kelas</a>
                        <a href="{{ route('daftar.ruangan') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.ruangan') == 0) ? 'active' : '' }}">Daftar Ruangan</a>
                ...
                <div class="col-md-9">
                  <div class="list-group">
                      <button type="button" class="list-group-item list-group-item-action active">Update Ruangan</button>
                      <form method="POST" action="{{ route('edit.putRuangan', $ruangan->id_ruangan) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                          <div class="col-md-12 mt-3">
                            ...
                            <input type="text" class="form-control" name="nama_ruangan" id="nama_ruangan" value="{{ $ruangan->nama_ruangan }}">
                          </div>
                        </div>
