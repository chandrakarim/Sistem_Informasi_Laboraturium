            ...
            <div class="row">
                <div class="col-md-3">
                  ...
                  <a href="{{ route('daftar.jadwal') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.jadwal')) ? 'active' : '' }}">Daftar Jadwal</a>
                        ...
                        <a href="{{ route('create.view.jadwal') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'create.view.jadwal')== 0) ? 'active' : '' }}">Buat Jadwal Baru</a> 
                ...
                <div class="col-md-9">
                  <div class="list-group">
                      <button type="button" class="list-group-item list-group-item-action active">Tambah Jadwal</button>
                      <form method="POST" action="{{ route('create.postJadwal') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4 mt-3">
                            ...
                            <input type="time" class="form-control" name="jam_selesai" id="jam_selesai" placeholder="Jam Mulai">
                          </div>
                        </div>
