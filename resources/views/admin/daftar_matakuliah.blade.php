    ...
    <div class="container">
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="list-group">
                        <button type="button" class="list-group-item list-group-item-action active">Daftar Matakuliah</button>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $m->sks }}</td>
                                    <td>
                                        <a href="{{ route('edit.view.matakuliah', $m->id_matkul) }}" class="btn btn-primary" type="button">Edit</a>
                                        <a href="{{ route('delete.matakuliah', $m->id_matkul) }}" class="btn btn-danger" type="button">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
