            ...
            <div class="row">
                <div class="col-md-3">
                  ...
                  <a href="{{ route('daftar.kelas') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.kelas')) ? 'active' : '' }}">Daftar Kelas</a>
                        ...
                        <a href="{{ route('daftar.matakuliah') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.matakuliah') == 0) ? 'active' : '' }}">Daftar Matakuliah</a>
                ...
                <div class="col-md-9">
                  <div class="list-group">
                      <button type="button" class="list-group-item list-group-item-action active">Update Matakuliah</button>
                      <form method="POST" action="{{ route('edit.putMatakuliah', $matakuliah->id_matkul) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                          <div class="col-md-12 mt-3">
                            ...
                            <input type="text" class="form-control" name="kode_matkul" id="kode_matkul" value="{{ $matakuliah->kode_matkul }}">
                          </div>
                        </div>
