    ...
    <div class="container">
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="list-group">
                        <button type="button" class="list-group-item list-group-item-action active">Daftar Jurusan</button>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('edit.view.jurusan', $j->id_jurusan) }}" class="btn btn-primary" type="button">Edit</a>
                                        <a href="{{ route('delete.jurusan', $j->id_jurusan) }}" class="btn btn-danger" type="button">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
