            ...
            <div class="row">
                <div class="col-md-3">
                  ...
                  <a href="{{ route('daftar.kelas') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.kelas')) ? 'active' : '' }}">Daftar Kelas</a>
                        ...
                        <a href="{{ route('create.view.ruangan') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'create.view.ruangan')== 0) ? 'active' : '' }}">Buat Ruangan Baru</a>
                ...
                <div class="col-md-9">
                  <div class="list-group">
                      <button type="button" class="list-group-item list-group-item-action active">Tambah Ruangan</button>
                      <form method="POST" action="{{ route('create.postRuangan') }}" enctype="multipart/form-data">
                        @csrf
