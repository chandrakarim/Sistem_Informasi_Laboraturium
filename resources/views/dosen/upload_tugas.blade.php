            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a href="{{ route('daftar.jadwaldosen') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.jadwaldosen')) ? 'active' : '' }}">Daftar Jadwal</a>
                      ...
                      <a href="{{route('create.view.tugas')}}" type="button" class="list-group-item list-group-item-action  {{ (strpos(Route::currentRouteName(), 'create.view.tugas') == 0) ? 'active' : '' }}">Upload Soal</a>
                ...
                <div class="col-md-9">
                    <div class="list-group">
                        <button type="button" class="list-group-item list-group-item-action active">Upload Soal</button>
                        <form method="POST" action="{{ route('create.postTugas') }}" enctype="multipart/form-data">
                          @csrf
                          ...
                          {{-- <div class="row">
                            <div class="col-md-12 mt-3">
                              <label for="pertemuan">Hari</label>
                              <select name="pertemuan" id="pertemuan" class="form-control">
                                <option value="ti">Senin</option>
                                <option value="si">Selasa</option>
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-12 mt-3">
                              <label for="file">Jam</label>
                              <input type="text" class="form-control" name="file" id="file" placeholder="jam">
                            </div>
                          </div> --}}
