            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a href="{{ route('daftar.jadwaldosen') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.jadwaldosen')) ? 'active' : '' }}">Daftar Jadwal</a>
                        <a href="{{ route('daftar.modul') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.modul') == 0) ? 'active' : '' }}">Daftar Modul</a>
                ...
                <div class="col-md-9">
                    <div class="list-group">
                        ...
                        <form method="POST" action="{{ route('update.modul', $moduls->id_modul) }}" enctype="multipart/form-data">
                          @csrf
                          ...
                          <div class="col-md-12 mt-3">
                            ...
                            <option selected value="{{$moduls->id_modul}}">{{$moduls->nama_matkul}}</option>
                          ...
                          <div class="row">
                            <div class="col-md-12 mt-3">
                              ...
                              <option selected value="{{$moduls->id_modul}}">{{$moduls->pertemuan}}</option>
                          ...
                          <div class="col-md-12 mt-3">
                            ...
                            <option selected value ="{{$moduls->id_modul}}">{{$moduls->nama_jurusan}}</option>
                        ...
                        <div class="row">
                          <div class="col-md-12 mt-3">
                            ...
                            <option selected value ="{{$moduls->id_modul}}">{{$moduls->nama_kelas}}</option>
                          ...
                          <div class="row">
                            <div class="col-md-12 mt-3">
                              ...
                              <input type="file" class="form-control" name="file" id="file" value="{{$moduls->file}}">{{$moduls->file}}
                            </div>
                          </div><br>
