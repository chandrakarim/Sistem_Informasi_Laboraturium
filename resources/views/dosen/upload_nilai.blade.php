            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a href="{{ route('daftar.jadwaldosen') }}" type="button" class="list-group-item list-group-item-action {{ (strpos(Route::currentRouteName(), 'daftar.jadwaldosen')) ? 'active' : '' }}">Daftar Jadwal</a>
                      ...
                      <a href="{{route('create.view.nilai')}}" type="button" class="list-group-item list-group-item-action  {{ (strpos(Route::currentRouteName(), 'create.view.nilai') == 0) ? 'active' : '' }}">Upload Nilai</a>
                ...
                <div class="col-md-9">
                    <div class="list-group">
                        <button type="button" class="list-group-item list-group-item-action active">Upload Nilai</button>
                        <form method="POST" action="{{ route('create.postNilai') }}" enctype="multipart/form-data">
                          @csrf
