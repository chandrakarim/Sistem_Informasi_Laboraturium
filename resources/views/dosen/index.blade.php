                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('edit.modul', $m->id_modul) }}" class="btn btn-primary" type="button">Edit</a>
                                        <a href="{{ route('delete.modul', $m->id_modul) }}" class="btn btn-danger" type="button">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
